            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <QuoteButton size="lg" className="bg-blue-600 hover:bg-blue-700">
                    Découvrir nos services
                    <ChevronRight className="ml-2 h-4 w-4" />
                  </QuoteButton>
                  <Link href="/contact" passHref>
                    <QuoteButton size="lg" variant="outline">
                      Nous contacter
                    </QuoteButton>
                  </Link>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Pourquoi Choisir Logiciels Comptables Et Financiers Comptabilité Pour Votre PME ?
                </h2>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Un accompagnement complet pour tirer le meilleur parti de logiciels comptables et financiers Comptabilité
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 mt-12">
              <div className="relative overflow-hidden rounded-lg border bg-white p-6 shadow-lg">
                <div className="flex flex-col space-y-4">
                  ...
                  <h3 className="text-2xl font-bold">Paramétrage complet de logiciels comptables et financiers Comptabilité</h3>
